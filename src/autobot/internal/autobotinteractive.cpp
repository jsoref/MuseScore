...
io::paths AutobotInteractive::selectMultipleDirectories(const QString& title, const io::path& dir, const io::paths& initiallyDirectories)
{
    return m_real->selectMultipleDirectories(title, dir, initiallyDirectories);
}
