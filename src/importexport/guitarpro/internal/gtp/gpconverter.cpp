...
void GPConverter::configureGraceChord(const GPBeat* beat, ChordRest* cr)
{
    ...
    auto rhythm = [](GPRhytm::RhytmType rhythm) {
        if (rhythm == GPRhytm::RhytmType::Whole) {
            return 1;
        } else if (rhythm == GPRhytm::RhytmType::Half) {
            return 2;
        } else if (rhythm == GPRhytm::RhytmType::Quarter) {
            return 4;
        } else if (rhythm == GPRhytm::RhytmType::Eighth) {
            return 8;
        } else if (rhythm == GPRhytm::RhytmType::Sixteenth) {
            return 16;
        } else if (rhythm == GPRhytm::RhytmType::ThirtySecond) {
            return 32;
        } else {
            return 64;
        }
